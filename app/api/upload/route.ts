...
export async function POST(request: NextRequest) {
  try {
    ...
    // Retry wrapper: absorbs transient DNS/network blips (getaddrinfo ENOTFOUND, fetch failed)
    // that occasionally happen on Vercel <-> Supabase, without masking real/persistent failures.
